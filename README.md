...
- **Sugestões diárias de conteúdo** (100% gratuito, sem chave de API): no topo do Dashboard, 3 fofocas/manchetes de entretenimento (famosos, filmes, séries, música, polêmicas) em alta em sites dos EUA e Europa (feeds RSS públicos: TMZ, Page Six, People, Just Jared, E! Online, Daily Mail, The Sun, Entertainment Weekly) + uma ideia de conteúdo conectando cada uma ao ensino de inglês (sorteada de um banco de modelos de ideia), com botão pra já mandar a ideia direto pro quadro de Conteúdo. Atualiza sozinho uma vez por dia (cache no banco), com botão manual pra gerar de novo.
